...
<body>
  <nav>
    <ul>
      ...
      <li onclick="cargarNuevaPagina('mostrar_venta.php')">Mostrar Ventas</li>
      <li onclick="mostrar_formulario('actualizar')">Actualizar</li>
      <li onclick="mostrar_formulario('eliminar')">Eliminar</li>
      <li onclick="cargarNuevaPagina('../venta_detalle copy/mostrar_detalle.php')">Mostrar Detalles de Ventas </li>
  ...
  <div id="insertar" class="Formulario">
    ...
    <form id="1" action="insertar_venta.php" method="post">
      ...
      <input type="number" id="monto_final" name="monto_final" step="0.01"  readonly  value="0"/><br /><br />
  ...
  <div id="actualizar" class="Formulario">
    <h2>Actualizar Informacion de Venta</h2>
    <form id="2">
...
/*     $(document).ready(function() {
      $("#1").submit(function(event) {
        ...
        cargarNuevaPagina("../venta_detalle copy/interfaz_detalle.php");
      });
    });
 */
