    ...
    <form id="2">
      ...
      <select id="id_proveedor1" name="id_proveedor" class="select">
        ...
        while ($fila = $resultado->fetch_assoc()) {
          $rut_proveedor = $fila["id"];
          $nombre_proveedor = $fila["nombre"];
          $direccion_proveedor = $fila["direccion"];
          $telefono_proveedor = $fila["contacto"];
          echo "<option value='$rut_proveedor'> [$rut_proveedor] - [$nombre_proveedor] - [$direccion_proveedor] - [$telefono_proveedor]</option>";
        }
        $conexion->close();
        ?>
      </select><br /><br />
